      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a href="/my-portfolio/cv/Sanduni_Hansika_CV_FD.pdf" download className="ml-2 px-4 py-2 bg-brand-green text-white rounded-md text-sm hover:bg-brand-green-dark transition">Download CV</a>
          </nav>
