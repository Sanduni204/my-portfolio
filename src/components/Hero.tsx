...
export default function Hero(){
  ...
  return (
    <header className="hero-grid bg-gradient-to-br from-brand-background-darkest to-brand-background-dark text-textc-primary py-28">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-poppins font-bold text-brand-green leading-tight">
              Sanduni Hansika
            </h1>
           ...
           <p className="mt-4 text-textc-secondary max-w-xl">
          A driven tech enthusiast focused on creating well-crafted, intuitive digital experiences. 
          I combine analytical thinking, thoughtful design, and reliable engineering to deliver solutions that are both effective and user-centered.
           </p>
              ...
              >
                Download CV
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v14m7-7H5"/></svg>
              </a>
            ...
            {/* Social icons (simple, pastel rings) */}
            <div className="flex items-center gap-3 mt-5">
                ...
                <a key={s.label} href={s.href} aria-label={s.label} className="p-2 rounded-full bg-brand-background-grey/80 card-soft text-textc-primary hover:text-brand-green transition">
                  <span className="w-6 h-6 inline-block" dangerouslySetInnerHTML={{ __html: s.svg }} />
                </a>
              ))}
            </div>
          </MDiv>
          ...
          >
            <div className="relative flex items-center justify-center" style={{ width: 320, maxWidth: '82%' }}>
              {/* Neon ring + circular portrait */}
              <div className="rounded-full p-1 bg-gradient-to-br from-brand-green-dark via-brand-green to-brand-green-light shadow-[0_0_30px_rgba(127,156,133,0.45)]">
                <div className="w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden bg-neutral-900 border-2 border-brand-background-grey">
                  <img src="/images/profile.png" alt="Sanduni Hansika" className="w-full h-full object-cover" />
                </div>
              </div>
