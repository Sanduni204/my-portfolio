...
">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.6fr_1fr] gap-10 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                href="/my-portfolio/cv/Sanduni_Hansika_CV_FD.pdf"
                download="Sanduni_Hansika_CV_FD.pdf"
        ...
        >
          <div className="relative flex items-center justify-center w-full max-w-xs sm:max-w-sm md:max-w-md mt-6 md:-mt-20 ">
